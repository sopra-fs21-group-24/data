...
## Contents
This repository stores our reports for the assignments we had to deliver throughout the semester for the Software Engineering courseat UZH.

Besides Assignments, assets (logos) & our data (csv file of locations worldwide) can be found here.
